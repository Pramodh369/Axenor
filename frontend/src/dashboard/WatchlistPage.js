  ...
  return (
    <div className="d-flex">
      ...
      <div className="flex-grow-1 p-5">
        <h2 className="fw-bold mb-4">Watchlist</h2>
        ...
        <div className="card border-0 shadow-sm p-4 mb-4">
          <div className="row g-3">
            ...
            <div className="col-md-3">
              <button className="btn btn-primary w-100" onClick={addWatchlist}>
            ...
            <tbody>
              {watchlist.map((item) => (
                <tr key={item._id}>
                  ...
                  <td
                    className={
                      item.change.includes("-") ? "text-danger" : "text-success"
                    }
                  >
                    {item.change}
                  </td>
                  ...
                  <td>
                    ...
                    <button
                      ...
                      onClick={() => deleteWatchlist(item._id)}
                    >
                      Delete
                    </button>
                  </td>
